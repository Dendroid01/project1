...
const About = () => {
    return (
        <>
            <section id="about" className="flex flex-col px-4 mb-6 md:mb-11 lg:mb-14 lg:pl-21.25 gap-9 md:gap-20 md:px-10">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-9 md:gap-11 lg:gap-39.5">
                    ...
                    <div className="flex flex-col md:w-95 lg:w-134.25 gap-6 mb-6 md:py-6 lg:py-23">
                        ...
                        <p className="text-body font-regular md:text-body-desktop text-grey-dark mt md:mb-5 lg:mb-9.5">
                            ...
                            specialist
                            in Frontend
                            development. <br className="hidden md:inline lg:hidden"/>Clear code is my passion.
