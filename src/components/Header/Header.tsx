...
const Header = () => {
    ...
    return (
        <>
            <header
                className="w-full bg-white py-3.5 px-4 md:px-10 lg:px-21.25 flex justify-between items-center  mb-7 md:mb-11 lg:mb-40 border-b border-grey-light sticky top-0 z-40">
